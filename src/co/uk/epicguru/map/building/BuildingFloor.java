...
public abstract class BuildingFloor extends BuildingObject {
	...
	public void ghostRender(Batch batch, Vector2 position, boolean valid){
		...
		batch.draw(texture, position.x - texture.getRegionWidth() / 2 / Constants.PPM, position.y - texture.getRegionHeight() / Constants.PPM / 2, texture.getRegionWidth() / Constants.PPM, texture.getRegionHeight() / Constants.PPM);
