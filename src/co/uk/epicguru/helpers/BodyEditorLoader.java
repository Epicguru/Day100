 ...
 * corresponding fixture ID, and it will attach these fixtures to your body.
 * 
...
public class BodyEditorLoader {
	...
	/** Creates and applies the fixtures defined in the editor. The ID parameter is used to retrieve the right fixture from the
	 * loaded file. <br/>
	 * <br/>
	 * 
	 ...
	 * @param ID The ID of the fixture you want to load.
	...
	/** Gets the image path attached to the given ID. */
	...
	/** Gets the origin point attached to the given ID. Since the point is normalized in [0,1] coordinates, it needs to be scaled
